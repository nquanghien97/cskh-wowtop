...
import { MenuType } from '@/constants/menuSidebar';
...
function Sidebar(props: SidebarProps) {
  ...
  return (
    <>
      ...
      <div className="w-[240px] fixed h-screen border-r border-[#ccc] flex flex-col">
        <div className="p-2 py-4 bg-[#2563eb] text-white text-center">
          {me?.fullName}
        </div>
        <div className="bg-[#f8e2b2] flex-1 overflow-x-hidden overflow-y-auto flex flex-col">
          ...
          <div className="flex justify-center">
            <Button type="primary" onClick={() => setIsOpenChangePassword(true)}>
              Đổi mật khẩu
            </Button>
          </div>
