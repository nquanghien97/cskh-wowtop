...
import { data_bmi } from '@/constants/data_bmi';
      ...
      <div className="p-4 rounded-xl" ref={elementRef}>
        ...
        <div className="mb-4 bg-insight-item rounded-2xl p-4">
          ...
          <ul className="flex flex-wrap text-lg">
            {fullName && <li className="w-1/2 py-1"><strong>- Họ tên:</strong> {fullName}</li>}
            {phoneNumber && <li className="w-1/2 py-1"><strong>- Số điện thoại:</strong> {phoneNumber}</li>}
